...
const Malaysia = () => {
  const malaysiaData = {
    ...
    programs: [{ title: "Malaysian Business", description: "Work in Malaysia's diverse business and hospitality sectors.", duration: "6-12 months", positions: "Business Operations, Hospitality, Technology", stipend: "RM1000-2000/month", location: "Kuala Lumpur, Penang, Johor Bahru" }],
