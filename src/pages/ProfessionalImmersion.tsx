    ...
    <div className="pt-16">
      ...
      <section className="py-20 bg-gradient-to-br from-red-50 via-white to-orange-50 relative overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="/src/assets/professional-immersion-hero.jpg" 
            alt="Professional Immersion Program" 
            className="w-full h-full object-cover opacity-10"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-red-50/80 via-white/80 to-orange-50/80"></div>
        </div>
