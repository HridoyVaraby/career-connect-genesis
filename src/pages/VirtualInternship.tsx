    ...
    <div className="pt-16">
      ...
      <section className="py-20 bg-gradient-to-br from-[#2FC1FF]/10 via-white to-[#F89827]/10 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-20 right-10 w-64 h-64 bg-[#2FC1FF]/5 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 left-10 w-80 h-80 bg-[#F89827]/5 rounded-full blur-3xl"></div>
        </div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-block bg-gradient-to-r from-[#2FC1FF] to-[#F89827] text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 animate-fade-in">
            ...
            <p className="text-xl text-gray-600 mb-4 animate-fade-in max-w-2xl mx-auto" style={{ animationDelay: '200ms' }}>
              Gain Global Work Experience—From Anywhere in the World
            </p>
            
            <p className="text-lg text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '400ms' }}>
            ...
            <div className="space-y-8">
              {supportPoints.map((point, index) => (
                <div key={point.title} className="flex items-start gap-6 group animate-fade-in" style={{ animationDelay: `${index * 150}ms` }}>
                  <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-r from-[#2FC1FF] to-[#F89827] rounded-full flex items-center justify-center text-2xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                    {point.icon}
                  </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in" style={{ animationDelay: '400ms' }}>
              ...
              <Button size="lg" variant="outline" className="border-2 border-gray-300 text-gray-700 hover:bg-gray-100 px-10 py-6 text-lg rounded-full transition-all duration-300 transform hover:scale-105">
