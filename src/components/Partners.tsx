...
const Partners = () => {
  const partners = [
    { name: "Welkin Vision", logo: "https://wp.ccidbd.com/wp-content/uploads/2022/11/Shozib.png" },
    { name: "Skill Development Institute", logo: "https://wp.ccidbd.com/wp-content/uploads/2022/11/Picture41.png" },
    { name: "TeachSmart", logo: "/teachsmart.png" },
    { name: "Hotel Propical Daisy", logo: "https://wp.ccidbd.com/wp-content/uploads/2022/11/logo-150x150-2.png" },
